...
export default function About() {
    ...
    useEffect(() => {
        if (inView && Date.now() - timeOfLastClick > 1000) setActiveState("#about");
    ...
    return (
        ...
        >
            ...
            <section className="text-lg text-center leading-8">
                <p>
                    Hey there! I'm <strong>Prajwal</strong>, a passionate CS undergraduate and a <strong>full stack developer</strong>. I have a knack for building robust and scalable web applications using modern technologies. With a keen interest in <em>problem-solving</em>, I thrive on challenges
                    and love to tackle complex problems head-on.
                </p>
