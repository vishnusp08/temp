    ...
    return (
        ...
        >
            ...
            <section className="text-lg text-center leading-8">
                <p>
                    Hey there! I&apos;m <strong>Vishnu S P</strong>i am <strong>full stack developer</strong>. I have a knack for building robust and scalable web applications using modern technologies. With a keen interest in problem-solving, I thrive on challenges and love
