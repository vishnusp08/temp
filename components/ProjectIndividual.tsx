...
export default function Project({
  ...
  return (
    ...
    >
      <section className="flex flex-col w-1/2 h-full pt-4 group-odd:pl-4 group-even:ml-[17rem] sm:group-even:ml-[22rem] pb-7 ">
