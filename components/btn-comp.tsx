...
export default function Btn() {
    ...
    return (
        <button type="submit" disabled={pending} className={"group hover:scale-110 active:scale-105 transition rounded-full text-sm font-semibold h-[3rem] w-[7rem] bg-black text-white flex justify-center gap-2 items-center disabled:opacity-75 disabled:scale-100"}>
            {!pending ? (
                <>
                    <p> Submit</p>
